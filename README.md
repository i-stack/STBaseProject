...
```swift
dependencies: [
    .package(url: "https://github.com/i-stack/STBaseProject.git", from: "1.1.0")
]
```
...
```ruby
pod 'STBaseProject/STBase', '~> 1.1.0'
pod 'STBaseProject/STContacts', '~> 1.1.0'
pod 'STBaseProject/STLocation', '~> 1.1.0'
# pod 'STBaseProject/STMedia', '~> 1.1.0'
# pod 'STBaseProject/STMarkdown', '~> 1.1.0'
```
